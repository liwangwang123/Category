...
@implementation UIImage (TwoDimensionCode)
...

{
    ...
    CGContextRef context = CGBitmapContextCreate(NULL, width, height, 8, 4 * width, colorSpace, kCGBitmapByteOrder32Little | kCGImageAlphaNoneSkipLast);
